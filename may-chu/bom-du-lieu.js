...
>>>>>>> fdcb9654aa8d2f635de75e238d805aee07d5cd14
        ...
        const defaultVariants = insertedProducts.map((product) => ({
            ten: "Phiên bản tiêu chuẩn",
            gia: product.gia,
            idSanPham: product._id,
            soLuong: product.soLuong || 50,
            daBan: product.daBan || 0,
        }));
        await BienThe.insertMany(defaultVariants);
        console.log(`✅ Đã thêm ${defaultVariants.length} biến thể mặc định.`);

      ...
      <div className="relative z-10 flex w-full max-w-6xl h-[650px] bg-[#0f172a]/80 backdrop-blur-2xl border border-white/10 rounded-[40px] shadow-2xl overflow-hidden m-4">
        ...
        <div className="hidden lg:block lg:w-3/5 relative overflow-hidden group">
          ...
          <div className="absolute bottom-12 left-12 text-white">
            <h1 className="text-5xl font-black italic mb-4 font-orbitron">
              STORE BUILD PC
            </h1>
            <p className="border-l-4 border-cyan-500 pl-4 text-gray-300">
              Khởi đầu kỷ nguyên công nghệ của riêng bạn.
            </p>
          </div>
        </div>
          ...
          {!isForgotPassword ? (
            <div className="animate-fadeIn">
              ...
              <form className="space-y-5" onSubmit={handleLogin}>
                <input
                  ...
                  placeholder="Email"
                  required
                  className="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-4 text-white outline-none focus:border-cyan-500"
                ...
                <button
                  type="submit"
                  className="w-full bg-cyan-600 hover:bg-cyan-500 text-white font-bold py-4 rounded-2xl shadow-lg transition-all transform active:scale-95 italic uppercase"
                >
                  Xác nhận đăng nhập
                </button>
              </form>
              <div className="relative flex items-center py-6">
                ...
                <span className="mx-4 text-gray-500 text-[10px] uppercase font-bold">
                  Hoặc
                </span>
                <div className="flex-grow border-t border-white/10"></div>
              </div>
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-white text-black font-bold py-3 rounded-2xl hover:bg-gray-200 transition-all shadow-md transform active:scale-95"
              >
                <img
            ...
            <div className="animate-fadeIn">
              <button
                ...
                className="text-gray-400 mb-6 italic text-sm hover:text-white transition"
              >
                ← Quay lại đăng nhập
              </button>
              ...
              <form className="space-y-6" onSubmit={handleForgotPassword}>
                ...
                <button
                  type="submit"
                  className="w-full bg-purple-600 hover:bg-purple-500 text-white font-bold py-4 rounded-2xl shadow-lg transform active:scale-95 italic uppercase"
                >
                  Gửi link xác nhận
                </button>
              </form>
